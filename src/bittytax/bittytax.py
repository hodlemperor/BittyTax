...
def main() -> None:
    ...
    if args.audit_only:
        ...
        if args.nopdf:
            ReportLog(args, audit, tax.tax_report, value_asset.price_report, tax.holdings_report, tax.yearly_holdings_report, tax.yearly_holdings_report_per_wallet, tax.daily_holdings_report)
        else:
            if args.format == ACCT_FORMAT_PDF:
                ReportPdf(
                    ...
                    tax.yearly_holdings_report_per_wallet,
